...
class Server {
  ...
  async watchFiles(watchPath, watchOptions = {}) {
    ...
    const matchesGlob = (
      /** @type {string} */ file,
      /** @type {string} */ pattern,
    ) => path.matchesGlob(absolute(file), absolute(pattern));
